/**
 * Auto-generated tests for Agent-TestAgent-1
...
describe('Agent-TestAgent-1', () => {
    ...
    describe('Decision Updates', () => {
        it('should have valid decision structure', () => {
            const decision = decisionsData.decisions.find(d => d.id === TestAgent-1);
            expect(decision).toBeDefined();
            expect(decision.id).toBe(TestAgent-1);
