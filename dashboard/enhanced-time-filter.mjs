...
class EnhancedTimeFilter extends LitElement {
    ...
    _emitFilterChange() {
        ...
        if (this.dateRangeStart || this.dateRangeEnd) {
            const startDate = this.dateRangeStart ? new Date(this.dateRangeStart) : null;
        ...
        this.dispatchEvent(new CustomEvent('time-filter-change', {
            detail: {
                filteredDecisions,
                filters: {
            ...
            <div class="stats-panel">
                <div class="stats-grid">
                    ...
                    <div class="stat-item">
                        ...
                        <span class="stat-value">${stats.averageCommitsPerDecision.toFixed(1)}</span>
                    </div>
                    ${stats.dateRange.span ? html`
                        <div class="stat-item">
                            <span class="stat-label">Time Span</span>
                            <span class="stat-value">${stats.dateRange.span} days</span>
                        </div>
                    ` : ''}
                    ${stats.commitActivity.totalCommits > 0 ? html`
                        <div class="stat-item">
                            <span class="stat-label">Total Commits</span>
                            <span class="stat-value">${stats.commitActivity.totalCommits}</span>
                        </div>
                    ` : ''}
                </div>
            </div>
    ...
    render() {
        ...
        return html`
            <div class="filter-header">
                ...
                <button class="stats-toggle" @click=${() => this.showStats = !this.showStats}>
            ...
            <div class="filter-body">
                ...
                <div class="filter-section">
                    ...
                    <div class="date-type-selector">
                        <button 
                            class="date-type-button ${this.selectedDateType === 'decision' ? 'active' : ''}"
                        ...
                        <button 
                            class="date-type-button ${this.selectedDateType === 'first_commit' ? 'active' : ''}"
                        ...
                        <button 
                            class="date-type-button ${this.selectedDateType === 'last_commit' ? 'active' : ''}"
                        ...
                        <button 
                            class="date-type-button ${this.selectedDateType === 'any' ? 'active' : ''}"
                ...
                <div class="filter-section">
                    ...
                    <div class="quick-filters">
                        <button class="quick-filter-button" @click=${() => this._applyQuickFilter('today')}>
                            Today
                        </button>
                        <button class="quick-filter-button" @click=${() => this._applyQuickFilter('week')}>
                            Last 7 Days
                        </button>
                        <button class="quick-filter-button" @click=${() => this._applyQuickFilter('month')}>
                            Last Month
                        </button>
                        <button class="quick-filter-button" @click=${() => this._applyQuickFilter('quarter')}>
                            Last Quarter
                        </button>
                        <button class="quick-filter-button" @click=${() => this._applyQuickFilter('year')}>
                            Last Year
                        </button>
                    </div>
                </div>
                    ...
                    <div class="activity-slider">
                        <div class="slider-header">
                            ...
                            <span class="slider-value">
                                ${this.recentActivityDays === 0 ? 'Off' : `${this.recentActivityDays} days`}
                            </span>
                        </div>
                        <input 
                            type="range" 
                ...
                <div class="filter-actions">
                    ...
                    <button class="action-button primary" @click=${this._emitFilterChange}>
                        Apply Filters
                    </button>
                </div>
            </div>
