...
class GitHubAuthorCard extends LitElement {
    ...
    _renderGitHubMeta() {
        ...
        return html`
            <div class="author-meta">
                ...
                ` : ''}
                ${this.author.profile_url ? html`
                    <a href="${this.author.profile_url}" target="_blank" rel="noopener noreferrer" class="github-link">
    ...
    _renderRecentDecisions() {
        ...
        return html`
            <div class="recent-decisions">
                ...
                ${recentDecisions.map(decision => html`
    ...
    render() {
        ...
        const acceptedCount = this.decisions.filter(d => d.status === 'Accepted').length;
        ...
        return html`
            <div class="author-card ${this.expanded ? 'expanded' : ''}" @click="${this._toggleExpanded}">
                <div class="author-header">
                    ...
                    <div class="author-info">
                        ...
                        ${isGitHubUser && this.author.github_username ? html`
                            <div class="author-username">@${this.author.github_username}</div>
                        ` : ''}
                    </div>
                ...
                ${this.expanded ? html`
                    ${this._renderGitHubMeta()}
                    ${this._renderRecentDecisions()}
                ` : ''}
            </div>
        `;
    }
