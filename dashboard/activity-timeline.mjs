    ...
    render() {
        ...
        return html`
            <div class="timeline-header">
                ...
                <div class="controls">
                    <button class="filter-button ${this.filter === 'all' ? 'active' : ''}"
                            @click="${() => this.setFilter('all')}">
                        All
                    </button>
                    <button class="filter-button ${this.filter === 'active' ? 'active' : ''}"
            ...
            ` : html`
                <div class="timeline">
                    ${filteredActivities.map(activity => this.renderTimelineItem(activity))}
                </div>
            `}
        `;
    }
            ...
            <div class="timeline-item" data-state="${activity.activity.state}">
                ...
                <div class="timeline-content">
                    ...
                    <div class="activity-body">
                        ${activity.activity.state === 'idle' ? html`
                            <span>Agent became idle</span>
                        ` : html`
                            <span>Started ${activity.activity.state}</span>
                        `}
                        
                        ${activity.activity.decisionId ? html`
                            <span> on 
                                <a href="#" class="decision-link" 
                                   @click="${(e) => this.handleDecisionClick(e, activity.activity.decisionId)}">
                                    Decision #${activity.activity.decisionId}
                                </a>
                            </span>
                        ` : ''}
                        
                        ${activity.activity.taskDescription ? html`
