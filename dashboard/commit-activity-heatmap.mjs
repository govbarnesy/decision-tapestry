...
class CommitActivityHeatmap extends LitElement {
    ...
    _handleDayClick(day) {
        ...
        this.dispatchEvent(new CustomEvent('heatmap-day-click', {
            detail: { 
                date: day.dateKey,
    ...
    _renderDay(day) {
        ...
        return html`
            <div 
                class="day-cell ${day.isFuture ? 'future' : ''} ${this.selectedDate === day.dateKey ? 'selected' : ''}"
    ...
    _renderHeatmap() {
        ...
        return html`
            ...
            <div class="legend">
                ...
                <div class="legend-item" style="background: var(--border); opacity: 0.5;"></div>
                <div class="legend-item" style="background: rgba(0, 82, 204, 0.25);"></div>
                <div class="legend-item" style="background: rgba(0, 82, 204, 0.5);"></div>
                <div class="legend-item" style="background: rgba(0, 82, 204, 0.75);"></div>
            ...
            <div class="summary">
                <div class="summary-stats">
                    ...
                    <div class="summary-stat">
                        <div class="summary-value current-streak">${stats.currentStreak}</div>
        ...
        return html`
            <div class="heatmap-header">
                <h3 class="heatmap-title">
                    <svg class="heatmap-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                ...
                <div class="heatmap-controls">
                    <select class="weeks-selector" @change=${(e) => this.weeks = parseInt(e.target.value)}>
                        <option value="13" ?selected=${this.weeks === 13}>Last 3 months</option>
                        <option value="26" ?selected=${this.weeks === 26}>Last 6 months</option>
