    ...
    render() {
        return html`
            ...
            <div id="analytics-controls" @click="${this.handlePeriodChange}">
                <button data-period="day" class="${this.activePeriod === 'day' ? 'active' : ''}">Day</button>
                <button data-period="week" class="${this.activePeriod === 'week' ? 'active' : ''}">Week</button>
                <button data-period="month" class="${this.activePeriod === 'month' ? 'active' : ''}">Month</button>
            </div>
